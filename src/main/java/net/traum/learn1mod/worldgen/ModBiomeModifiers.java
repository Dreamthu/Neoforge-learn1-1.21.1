...
public class ModBiomeModifiers {
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(SPAWN_GECKO, new BiomeModifiers.AddSpawnsBiomeModifier(
                ...
                List.of(new MobSpawnSettings.SpawnerData(ModEntities.GECKO.get(), 10, 2, 4))));
    }

    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, ResourceLocation.fromNamespaceAndPath(Learn1Mod.MOD_ID, name));
    }
}
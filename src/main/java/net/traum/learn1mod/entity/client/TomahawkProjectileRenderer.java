...
import net.traum.learn1mod.entity.custom.TomahawkProjectileEntity;
...
public class TomahawkProjectileRenderer extends EntityRenderer<TomahawkProjectileEntity> {
    ...
    public ResourceLocation getTextureLocation(TomahawkProjectileEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(Learn1Mod.MOD_ID, "textures/entity/tomahawk/tomahawk.png");
    }
}
